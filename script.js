...
// Auto-Play Music + Interactive Scratch
// ================================
...
function autoPlayMusic() {
    music.play().catch((error) => {
        ...
        // Music will auto-play on first user interaction
...
function setupScratchLayer() {
    ...
    // Create gradient fill for the scratch layer
...
function checkScratchProgress() {
    ...
    // If 50% scratched, start fading out
...
function startParticles() {
    ...
    // Stop particles after 20 seconds
    setTimeout(() => {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Keyboard support for music control
